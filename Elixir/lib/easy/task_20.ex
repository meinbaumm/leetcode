defmodule Easy.Task20 do
  ...
  defp check_is_valid([head | tail] = input_chars, stack)
       when is_list(input_chars) and is_open_bracket(head) do
    stack = [head | stack]
    check_is_valid(tail, stack)
  end

  defp check_is_valid([head | tail] = input_chars, stack)
       when is_list(input_chars) and is_closed_bracket(head) do
